...
function onSectionViewPageLoad() {
    $.ajax({
        url: "http://127.0.0.1:5000/api/v1/yearsessions",
        type: "GET",
...
function updateSVSubjectDropdown(yearsession) {
    ...
    $.ajax({
        url: `http://127.0.0.1:5000/api/v1/subjects/${yearsession}`,
        type: "GET",
        success: function (response) {
...
function updateSVCourseDropdown(subject) {
    ...
    $.ajax({
        url: `http://127.0.0.1:5000/api/v1/courses/${yearsession}/${subject}`,
        type: "GET",
        success: function (response) {
...
function updateSVSectionDropdown(course) {
    ...
    $.ajax({
        url: `http://127.0.0.1:5000/api/v1/sections/${yearsession}/${subject}/${course}`,
        type: "GET",
        success: function (response) {
...
function getSectionGrades(button, yearsession, subject, course, section) {
    ...
    // Send API request
    $.ajax({
        url: `http://127.0.0.1:5000/api/v1/grades/${yearsession}/${subject}/${course}/${section}`,
        type: "GET",
